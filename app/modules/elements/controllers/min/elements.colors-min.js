...
angular.module('designSystemApp')
    .controller('ColorsCtrl', ['$scope', '$route', '$location', '$timeout', '$log', 'ColorFactory',
        function($scope, $route, $location, $timeout, $log, ColorFactory ) {
          ...
          //console.log($scope.colorData.blues[0].hex);
